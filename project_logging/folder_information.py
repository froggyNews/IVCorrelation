...
class FolderAnalyzer:
    ...
    def extract_functions_and_classes(self, file_path: str) -> Dict[str, List[str]]:
        ...
        try:
            ...
            return {
                'functions': [f"Error parsing file: {str(e)}"],
                'classes': [],
                'function_io': {}
            }
    ...
    def get_folder_structure(self) -> List[Tuple[str, int]]:
        ...
        skip_dirs = {'venv', '.venv', 'env', '.env', 'node_modules', '__pycache__', '.git', '.pytest_cache', 'dist', 'build'}
            ...
            try:
                ...
                for item in items:
                    ...
                    if (item.name.startswith('.') or 
                        item.name in skip_dirs or 
                        item.name.endswith('.pyc') or
    ...
    def generate_report(self) -> str:
        ...
        report_lines.append(f"PROJECT STRUCTURE AND CODE ANALYSIS REPORT")
...
def run_analysis():
    ...
    print(f"✅ Folder analysis complete!")
