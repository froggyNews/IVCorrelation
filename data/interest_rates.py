...
def save_ticker_interest_rates(ticker_rates: List[dict], source_file: str) -> int:
    ...
    ticker_rates: List of dicts with keys: ticker, rate_date, rate_value, fee, adjusted_float, lender_count, borrow_status
    ...
    try:
        ...
        for ticker in df['Stock'].unique():
            ...
            rate_info = {
                ...
                'adjusted_float': first_row.get('Adjusted Float') if pd.notna(first_row.get('Adjusted Float')) else None,
