...
- Tests cover configuration changes, composite Index construction, surface building, and edge cases

### Running the Application

#### CLI Analysis (1-2 seconds per run)
- Main demo script: `python scripts/scripts_composite_index_demo.py --target SPY --peers QQQ IWM --no-show`
- View help: `python scripts/scripts_composite_index_demo.py --help`
...
2. **Test basic analysis**: `python scripts/scripts_composite_index_demo.py --target SPY --peers QQQ --no-show` (1.5 seconds)
...
5. Check composite Index construction produces valid weights and metrics

## Key File Locations

### Core Analysis Engine
- `analysis/analysis_pipeline.py` - Main orchestration, caching, configuration
- `analysis/compositeIndexBuilder.py` - composite Index surface construction  
...
### Entry Points
- `scripts/scripts_composite_index_demo.py` - Main CLI demo
...
- **Analysis**: `python scripts/scripts_composite_index_demo.py --target SPY --peers QQQ --no-show` -- 1.5 seconds. NEVER CANCEL. Use timeout 30+ seconds.
...
python scripts/scripts_composite_index_demo.py --target SPY --peers QQQ IWM GOOGL --no-show

# Test working weight modes (corr and equal work, pca/cosine have bugs)
python scripts/scripts_composite_index_demo.py --target SPY --peers QQQ --weight-mode equal --no-show

# Export results for inspection
python scripts/scripts_composite_index_demo.py --target SPY --peers QQQ --no-show --export-dir /tmp/results
```
